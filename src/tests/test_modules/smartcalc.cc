...
// TEST(smartcalc, other_test_36) {
//   std::string infix =
//   "x(((ln(cos(1.5*atan(1)))/(log(x*sqrt(x))))+log((tan(1)-asin(0.25))/(ln(x)+sqrt(x)))))";
//   Polish pol{infix};

//   long double exp = -65.10591505L;
//   long double res = pol.evaluate();
...
// TEST(smartcalc, other_test_37) {
//   std::string infix = "sqrt(x*x*xx*x*x)x";
//   Polish pol{infix};
...
// TEST(smartcalc, other_test_38) {
//   std::string infix = "log(((sqrt(x*x*xx*x*x)x)^2/1.25566*15.2333)/x^2)";
//   Polish pol{infix};
...
// TEST(smartcalc, other_test_40) {
//   std::string infix = "e * e -
//   (log(3654234)-sqrt(4345)*log(2234)*65324*(ln(2654.5645)-ln(6541))+(5747-log(561.5345)/ln(3534)))/(5432-(sqrt(4230.4325)/sin(log(6541)+log(10)-4232*ln(1654.655))))";
//   Polish pol{infix};
